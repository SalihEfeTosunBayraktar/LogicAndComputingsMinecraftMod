...
@Mod("logicandcomputings")
public class LogicandcomputingsMod {
	public static final Logger LOGGER = LogManager.getLogger(LogicandcomputingsMod.class);
	public static final String MODID = "logicandcomputings";

	public LogicandcomputingsMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		LogicandcomputingsModBlocks.REGISTRY.register(modEventBus);
		LogicandcomputingsModBlockEntities.REGISTRY.register(modEventBus);
