...
public class AndGateBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(0, ItemStack.EMPTY);

	public AndGateBlockEntity(BlockPos position, BlockState state) {
		super(LogicandcomputingsModBlockEntities.AND_GATE.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("and_gate");
	}
	...
	public Component getDisplayName() {
		return Component.literal("AND Gate");
	}
