...
public class OrGateBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(0, ItemStack.EMPTY);

	public OrGateBlockEntity(BlockPos position, BlockState state) {
		super(LogicandcomputingsModBlockEntities.OR_GATE.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("or_gate");
	}
	...
	public Component getDisplayName() {
		return Component.literal("OR Gate");
	}
