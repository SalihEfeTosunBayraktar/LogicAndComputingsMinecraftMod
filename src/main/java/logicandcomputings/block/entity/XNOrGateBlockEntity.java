...
public class XNOrGateBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(0, ItemStack.EMPTY);

	public XNOrGateBlockEntity(BlockPos position, BlockState state) {
		super(LogicandcomputingsModBlockEntities.XN_OR_GATE.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("xn_or_gate");
	}
