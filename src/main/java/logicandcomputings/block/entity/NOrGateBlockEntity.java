...
public class NOrGateBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(0, ItemStack.EMPTY);

	public NOrGateBlockEntity(BlockPos position, BlockState state) {
		super(LogicandcomputingsModBlockEntities.N_OR_GATE.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("n_or_gate");
	}
