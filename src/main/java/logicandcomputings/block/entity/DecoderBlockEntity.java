...
public class DecoderBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(9, ItemStack.EMPTY);

	public DecoderBlockEntity(BlockPos position, BlockState state) {
		super(LogicandcomputingsModBlockEntities.DECODER.get(), position, state);
	}
