...
public class XOrGateBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(0, ItemStack.EMPTY);

	public XOrGateBlockEntity(BlockPos position, BlockState state) {
		super(LogicandcomputingsModBlockEntities.X_OR_GATE.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("x_or_gate");
	}
	...
	public Component getDisplayName() {
		return Component.literal("XOR Gate");
	}
